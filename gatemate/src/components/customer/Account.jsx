...
export const Account = () => {
    ...
    return (
      <>
        ...
        <FeatureComingSoonModal
          ...
          featureName="Commercial B2B RFQs"
        />
      </>
    );
  }
  ...
  const quickLinks = [
    ...
    },
    {
      ...
      desc: "Commercial quotation and bulk project features",
      icon: Building2,
      type: "coming-soon",
    },
    {
  ...
  return (
    <>
                ...
                if (item.type === "coming-soon") {
                  return (
                    <button
                      key={item.title}
                      type="button"
                      onClick={openB2BComingSoon}
                      className="gm-card gm-card-hover p-5 rounded-2xl flex items-start justify-between gap-4 group text-left w-full"
                    >
                      <div className="flex items-start gap-3.5">
                        ...
                        <div>
                          ...
                          <span className="inline-flex mt-2 px-2 py-0.5 rounded-full bg-[#E4EEF3] border border-[#D9E2EA] text-[9px] font-bold uppercase tracking-wide text-[#3C7DDA]">
                            Coming Soon
                          </span>
                        </div>
                      </div>
      ...
      {/* Commercial B2B RFQs — Coming Soon */}
      <FeatureComingSoonModal
        isOpen={comingSoonOpen}
        onClose={() => setComingSoonOpen(false)}
        featureName="Commercial B2B RFQs"
        title="Coming Soon"
        description="Commercial B2B RFQs, quotations, and bulk project ordering are currently under development."
      />
    </>
  );
};
