  ...
  if (!authLoading && !user) {
    return (
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-6">
        <h1 className="text-2xl font-black text-white">Saved Wishlist</h1>
          ...
          <div className="md:col-span-3">
            <div className="premium-panel p-12 rounded-3xl text-center space-y-4 max-w-md mx-auto">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Please sign in to view and manage your private wishlist.
              </p>
              <button
        ...
        <div className="md:col-span-3 space-y-4">
          {loading ? (
            ...
            <div className="premium-panel p-16 rounded-3xl text-center space-y-4 max-w-md mx-auto">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                Save gate hardware, ceramic pottery, and architectural decor as
                ...
                >
                  ...
                  <div className="p-4 pt-0">
                    <button
                      ...
                      className="w-full gold-gradient-btn py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition active:scale-95 shadow-md"
                    >
